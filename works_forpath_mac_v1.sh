...
declare -A PLATFORMS=(
    ["nes"]="https://archive.org/download/No-Intro-Collection_2016-01-03_Fixed/Nintendo%20-%20Nintendo%20Entertainment%20System.zip"
    ["snes"]="https://archive.org/download/snes-usa-romset-complete-collection.-7z"
    ["genesis"]="https://archive.org/download/sega-genesis-romset-ultra-usa"
    ["gb"]="https://archive.org/download/Cyles_Gameboy_roms"
...
list_platforms() {
    ...
    local i=1
    local platforms_array=("nes" "snes" "genesis" "gb" "gba")
    local descriptions=(
...
search_roms() {
    ...
    case "$platform" in
        "nes")
            archive_url="https://archive.org/download/No-Intro-Collection_2016-01-03_Fixed/Nintendo%20-%20Nintendo%20Entertainment%20System.zip"
            ;;
        "snes")
            archive_url="https://archive.org/download/snes-usa-romset-complete-collection.-7z"
            ;;
        "genesis")
            archive_url="https://archive.org/download/sega-genesis-romset-ultra-usa"
            ;;
        "gb")
            archive_url="https://archive.org/download/Cyles_Gameboy_roms"
            ;;
        "gba")
